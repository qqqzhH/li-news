export interface NewsItem {
  ...
  summary: string;
  deepDive: string;
  category: "ai" | "geopolitics" | "finance" | "robotics" | "other";
  source: string;
  sourceUrl: string;
  publishedAt: string;
...
export const CATEGORY_ICONS: Record<string, string> = {
  ...
  recommended: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>`,
  ai: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2l2.5 6.5L21 10l-6.5 2.5L12 19l-2.5-6.5L3 10l6.5-2.5z"/><path d="M3 10l6.5-2.5L12 2l2.5 6.5L21 10"/></svg>`,
