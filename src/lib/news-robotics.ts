...
const items: NewsItem[] = [
  {
    ...
    deepDive: "## AI 解读\n\n### 核心要点提炼\n1. 技术突破：苏州智行腱的“人工肌腱”实现微米级精度与高功率密度，灵感机器人的视觉触觉传感器达到商用级指尖大小，标志着机器人从“关节电机”向“仿生肌肉+电子皮肤”的范式转移。\n2. 产业拐点：FAIR plus 2026展会显示，机器人产业正从“技术验证”迈入“规模化交付”，具身智能全面渗透千行百业，2025年深圳产业链产值增速重回20%以上。\n3. 生态协同：500家企业参展、25场供需对接会促成真实订单，标准制定（3项国标、2项团标）加速产业规范化，中国原创技术进入爆发期。\n\n### 影响分析\n- 产业链重塑：人工肌腱和触觉传感器将催生高附加值细分赛道，如AI玩具、仿真脸、灵巧手，推动上游材料与驱动技术升级；下游应用场景从工业延伸至医疗、养老、零售等，打开千亿级市场空间。\n- 竞争格局变化：中国初创企业以原创技术打破海外垄断，形成差异化优势；但市场教育成本高（如触觉感知需求认知不足），需依赖头部客户示范效应加速渗透。\n- 投资风向标：具身智能成为资本重点布局领域，技术壁垒高、量产能力强的企业将获优先青睐；全球化路径明确，中国机器人本体企业有望协同海外模型公司输出“感知+执行”整体方案。",
    category: "robotics",
    source: "Exa 搜索",
  ...
  },
  {
    ...
    deepDive: "## AI 解读\n\n### 核心要点提炼\n\n1. 产品发布：NVIDIA推出Cosmos 3，这是全球首款完全开放的物理AI全模态基础模型，基于混合Transformer架构，原生支持文本、图像、视频、环境音和动作的推理与生成。\n2. 生态建设：NVIDIA联合Agile Robots、Runway等企业成立Cosmos Coalition，旨在推动开放世界模型的技术共享与标准化，加速物理AI从研发到部署的进程。\n3. 应用价值：该模型可将物理AI的训练和评估周期从数月缩短至数天，显著降低机器人、自动驾驶等领域的开发门槛与成本。\n\n### 影响分析\n\n- 行业层面：Cosmos 3将物理AI的“通用性”提升至新高度。其全模态能力可统一感知、规划与执行，有望终结当前机器人开发中“仿真-训练-部署”的碎片化现状，推动行业从专用模型向通用基础模型转型。Cosmos Coalition的成立则可能形成类似CUDA生态的“物理AI标准”，吸引更多开发者入驻NVIDIA平台，强化其软硬件一体化护城河。\n- 竞争格局：此举直接挑战现有机器人及自动驾驶领域的封闭式开发模式。开放模型策略能吸引学术与中小开发者，加速技术迭代，但同时也对NVIDIA自身的算力销售（如DGX Cloud）构成正向拉动。对于竞争对手（如特斯拉、Waymo），这要求其必须在数据闭环或垂直整合上建立差异化优势。\n- 风险提示：物理AI的安全性需高度关注。开放模型可能被用于开发未经充分验证的自主系统，增加事故风险。此外，混合Transformer架构的算力消耗与边缘部署（如Cosmos 3 Edge）的实时性平衡，仍是实际落地的关键瓶颈。",
    category: "robotics",
    source: "Exa 搜索",
  ...
  },
  {
    ...
    deepDive: "## AI 解读\n\n### 深度分析：银河通用LDA——具身智能的“GPT-2时刻”\n\n1. 核心要点提炼\n\n银河通用发布的LDA模型，核心突破在于首次系统性地解决了具身智能领域的数据异构难题。其关键创新并非单一模型架构，而是构建了“银河星数”数据基础设施，并提出了“世界-动作模型”（WAM）范式。LDA能够统一利用虚实、人机、有无动作标签、质量参差的全域数据，使低质量和无标注数据同样能驱动模型性能持续提升。这标志着具身智能从“数据稀缺驱动”正式进入“数据规模驱动”的新阶段，类似于GPT-2对语言模型的范式革命。\n\n2. 影响分析\n\n   对行业格局的影响：LDA将大幅降低具身智能的数据获取门槛。以往依赖昂贵、稀缺的高质量专家数据（如遥操作）的瓶颈被打破，互联网海量视频和仿真数据得以有效利用。这会加速技术迭代，并可能催生一批专注于数据基础设施和模型预训练的公司，重塑行业竞争格局。\n   对技术路线的影响：LDA验证了“世界模型”与“动作模型”统一（WAM）的技术可行性，为具身智能模型从“感知-动作”的简单映射，进化到对物理世界演化具备深度理解的“认知-执行”模式提供了关键路径。这或将成为未来具身基座模型的主流范式。\n   对应用落地的意义：规模化学习能力意味着具身智能系统的通用性和泛化能力将显著提升。机器人有望在更复杂、更开放的真实环境中自主学习和执行任务，推动其在物流、制造、家庭服务等领域的商业化落地进程。",
    category: "robotics",
    source: "Exa 搜索",
