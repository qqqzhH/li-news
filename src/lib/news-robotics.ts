...
const items: NewsItem[] = [
  {
    ...
    deepDive: "## AI 解读\n\n### 核心要点提炼\n\n1. 技术突破方向：机器人从“关节电机+减速器”的传统范式，转向“仿生肌肉”与“电子皮肤”两大拟人化技术。苏州智行腱的“人工肌腱”实现微米级精度与高功率密度，灵感机器人的视觉触觉传感器则赋予机器人精细触觉感知能力。\n2. 产业化加速：FAIR plus 2026展会显示，具身智能已从概念验证进入规模化交付阶段。现场25场供需对接会促成数百项真实采购需求，深圳机器人产业链产值增速重回20%以上，2026年人形机器人头部厂商有望实现万台级交付。\n3. 标准与生态构建：深圳同步推进3项国家标准、2项团体标准研制，中国原创技术从“抄袭”进入爆发期，灵巧手市场占有率有望领跑全球。\n\n### 影响分析\n\n短期：仿生肌肉与触觉传感器的突破将直接赋能AI玩具、仿真脸、灵巧手等细分场景，推动人形机器人在服务、医疗、制造等领域的落地。产业链从“单点技术展示”转向“供需对接+订单敲定”，加速商业化闭环。\n\n长期：具身智能全面渗透千行百业，传统工业机器人时代落幕。中国在核心部件（如人工肌腱、触觉传感器）上的原创性突破，将重塑全球机器人竞争格局。标准制定权的争夺成为下一阶段产业制高点，深圳有望成为全球具身智能创新策源地。",
    category: "robotics",
    source: "Exa 搜索",
  ...
  },
  {
    ...
    deepDive: "## AI 解读\n\n### 核心要点提炼\n\n摩根士丹利报告明确，人形机器人行业将在2026年下半年迎来量产拐点。核心驱动有三：一是头部企业密集IPO，资本市场情绪高涨；二是Figure AI在仓储场景中验证了人形机器人与人类效率持平（仅慢1.5%），证明商业化可行性；三是特斯拉、Figure等开启产能爬坡，供应链需求率先爆发。产业链呈现“身体先行”特征，减速器、电机等零部件板块领涨，而“大脑”类公司涨幅滞后。\n\n### 影响分析\n\n1. 投资逻辑重构：短期利润让位于规模，行业头部企业净利润率从35%下滑至22%-25%，但市场给予更高估值溢价。投资者应重点关注具备量产能力的整机厂商及核心零部件供应商，尤其是中国供应链企业，因产能爬坡带来确定性需求红利。\n\n2. 场景落地路径清晰：仓储物流成为首个验证场景，人形机器人将遵循“结构化→非结构化”的迭代路径。产品经理需聚焦单一任务、高ROI场景，避免陷入“通用能力陷阱”。家庭、医疗等复杂场景仍需2-3年技术积累。\n\n3. 产业链分化加剧：身体类零部件（减速器、电机、传感器）率先受益，集成商次之，大脑类（AI芯片、算法）短期弹性不足。中国企业在身体类环节具备成本与产能优势，有望成为全球供应链核心环节。\n\n4. 风险提示：量产爬坡不及预期、技术路线分歧（如灵巧手方案）、政策监管趋严可能影响板块估值。2026年下半年需重点关注特斯拉Optimus量产节奏及Figure BotQ工厂产能利用率。",
    category: "robotics",
    source: "Exa 搜索",
  ...
  },
  {
    ...
    deepDive: "## AI 解读\n\n### 深度分析：NVIDIA Cosmos 3 —— 物理AI的“操作系统”雏形\n\n1. 核心要点提炼\nNVIDIA今日发布Cosmos 3，这是全球首个完全开放的全模态物理AI基础模型。其核心突破在于：基于混合Transformer架构，首次将视觉推理、世界生成与动作预测整合为单一系统。模型原生支持文本、图像、视频、环境音和动作的跨模态理解与生成，将物理AI训练周期从数月压缩至数天。同时，NVIDIA联合多家头部AI与机器人企业成立“Cosmos Coalition”，推动开放世界模型生态。\n\n2. 影响分析\n- 对机器人行业： Cosmos 3实质上构建了物理世界的“通感”能力。机器人开发者不再需要为感知、规划、控制分别训练模型。一个模型即可完成从“看到杯子”到“理解杯子是易碎品”再到“规划抓取轨迹”的全链路推理。这大幅降低了具身智能的研发门槛，加速通用机器人的商业化落地。\n- 对自动驾驶与仿真： 模型原生具备世界仿真能力，可用于生成高保真、物理准确的合成数据。这将有效解决自动驾驶中长尾场景数据稀缺的痛点，使仿真训练从“工具”升级为“核心生产力”。\n- 对AI产业格局： NVIDIA通过“开放模型+联盟生态”的策略，正在将物理AI的标准与底层架构锚定在自身平台。这不仅是技术发布，更是生态布局。Cosmos Coalition的成立，意味着NVIDIA意图复制其在AI训练芯片领域的统治力，将物理AI的“训练-仿真-部署”全流程绑定至CUDA与DGX生态。\n\n结论： Cosmos 3不仅是模型，更是一个物理世界的“数字基座”。它标志着AI从“理解文字与图像”正式迈入“理解并作用于物理规律”的新阶段。对于投资者与从业者，需关注其生态扩张速度，这将是衡量物理AI产业化进程的关键指标。",
    category: "robotics",
    source: "Exa 搜索",
