...
const items: NewsItem[] = [
  ...
  },
  {
    ...
    deepDive: "## AI 解读\n\n### 核心要点提炼\n1. 行业范式转移：人形机器人竞争焦点从“本体工程”（硬件、运动控制）转向“智能大脑”（大模型、AI交互），标志性事件是“本体派”代表王兴兴公开强调模型能力的关键性。\n2. 量产成熟驱动转舵：国内人形机器人本体产能已跨过临界点（年产5000台能力、超140家企业），硬件趋于同质化，迫使厂商从“堆产能”转向“拼智能”。\n3. 补课模型成必选项：宇树、众擎、松延等本体厂商通过自研或合作方式加速模型布局，而蚂蚁、车企等“重脑轻体”玩家同步入场，形成双向挤压。\n\n### 影响分析\n- 产业格局重塑：纯本体厂商的存活空间收窄，具备“本体+模型”垂直整合能力的企业将主导下一阶段竞争。头部厂商（如宇树、智元）凭借量产规模和数据积累，在模型迭代中占据先机；中小厂商需依赖开放平台或细分场景（如安防、教育）差异化突围。\n- 投资逻辑切换：市场估值重心从“量产能力”转向“模型落地效率”。具备VLA大模型、世界模型等核心技术储备的初创企业（如蚂蚁灵波）可能获得更高溢价，而纯硬件代工厂商面临估值压缩。\n- 生态竞争升级：开源模型（如宇树UnifoLM-VLA-0）与商业闭源模型并行，将加速行业标准化，但也会加剧技术路径分化。车企（如特斯拉）、互联网巨头（如阿里）可能通过场景绑定（智能制造、家庭服务）构建护城河，挤压独立机器人厂商的生存空间。\n\n总结：人形机器人已进入“得模型者得天下”的深水区，短期看，本体厂商的模型补课将引发一轮技术并购与人才争夺；长期看，只有实现“硬件规模反哺数据、数据驱动模型进化”的闭环企业，才能穿越周期成为最终赢家。",
    category: "robotics",
    source: "Exa 搜索",
