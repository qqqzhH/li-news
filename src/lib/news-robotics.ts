...
const items: NewsItem[] = [
  ...
  },
  {
    ...
    deepDive: "## AI 解读\n\n### 深度分析：比亚迪人形机器人“尧舜禹”项目\n\n核心要点提炼：\n1. 战略确认：比亚迪首次官方证实自研人形机器人“尧舜禹”，2022年立项，2026年计划内部部署2万台，优先替代产线重复性岗位。\n2. 技术进展：第七代原型机已迭代，双足行走速度1.5米/秒，负载50公斤，作业效率达人工80%；核心零部件自研率超80%，与汽车通用率超60%。\n3. 生态布局：通过“自研+投资”双轮驱动，入股智元机器人、帕西尼感知科技，并与港科大共建联合实验室，覆盖触觉传感器等关键环节。\n4. 市场反应：资本市场反应平淡，股价小幅下跌，分析师认为短期难贡献业绩，关注与汽车主业的协同效应。\n\n影响分析：\n- 对行业：比亚迪依托造车全链条优势（制造、供应链、芯片、场景）切入人形机器人，将加速行业从“技术驱动”向“场景驱动”转型。其成本控制能力（自研电机成本低40%、减速器低60%）可能挤压初创企业生存空间，推动产业链整合。\n- 对自身：人形机器人作为第二增长曲线，与汽车业务协同性高（智驾芯片“璇玑A3”可复用、超60%零部件通用），有望复制新能源汽车的规模化降本路径。但初期投入大，2026年2万台部署尚属内部验证阶段，业绩贡献需至2028年后。\n- 风险提示：技术成熟度、场景适配性及商业化节奏仍是关键变量。若2028年大规模落地不及预期，或影响投资者信心。",
    category: "robotics",
    source: "Exa 搜索",
  ...
  },
  {
    ...
    deepDive: "## AI 解读\n\n### 核心要点提炼\n\n1. 量产拐点确立：摩根士丹利报告指出，2026年下半年人形机器人行业将进入“量产前夜”，头部企业加速IPO，产能爬坡推动场景从技术演示转向规模化落地。\n2. 仓储场景验证：Figure AI完成200小时连续自主仓储分拣，效率仅比人类慢1.5%，首次证明结构化场景下商业化可行性。\n3. 供应链红利释放：整机厂商量产率先利好中国“身体”类零部件板块（减速器、电机等），5月月内涨幅达11%，而“大脑”类公司涨幅滞后。\n\n### 影响分析\n\n- 产业逻辑：人形机器人遵循“身体先行”路径，仓储物流作为首个MVP场景，验证了结构化环境下的ROI可行性。未来1-2年产品迭代将聚焦工业场景，家庭等复杂场景仍需技术突破。\n- 投资方向：短期关注中国供应链中减速器、执行器等“身体”类核心零部件龙头，其需求确定性最强；中长期需跟踪整机厂商毛利率改善及场景拓展节奏。\n- 风险提示：行业仍处“利润让位于规模”阶段，头部企业净利润率已从35%下滑至22%-25%，需警惕估值泡沫与量产不及预期风险。",
    category: "robotics",
    source: "Exa 搜索",
  ...
  },
  {
    ...
    deepDive: "## AI 解读\n\n### 核心要点提炼\n1. 技术突破：机器人从“关节电机+减速器”的传统范式，转向“仿生肌肉”与“电子皮肤”两大前沿。苏州智行腱的“人工肌腱”实现微米级精度与类人直线运动；灵感机器人的视觉触觉传感器填补了精细操作中“力触觉”的空白。\n2. 产业拐点：FAIR plus 2026展会标志着机器人产业从“技术验证”迈入“规模化交付”。具身智能全面渗透千行百业，深圳机器人产业链产值增速重回20%以上，真实采购需求取代PPT展示，供应链对接成为核心。\n\n### 影响分析\n- 短期催化：仿生肌肉与触觉感知技术将直接加速人形机器人、灵巧手、AI玩具等细分赛道的商业化落地。2026年头部厂商万台级交付目标可期，中国灵巧手市场有望领跑全球。\n- 长期重构：具身智能的渗透将重塑制造、医疗、养老等行业的作业模式。原创技术爆发（如中国自研“人工肌腱”）打破海外垄断，标准制定（深圳推进3项国标）抢占产业制高点。同时，市场教育成本仍需消化，触觉感知的工程化与实时性瓶颈待解。\n\n结论：机器人正经历“能动”到“类人”的质变，技术原创性与产业链协同能力决定未来十年胜负。",
    category: "robotics",
    source: "Exa 搜索",
  ...
  },
  {
    ...
    deepDive: "## AI 解读\n\n### 核心要点提炼\n星海图发布双足机器人「行客Kengo」，核心差异化在于“先有脑，后有腿”——其具身基础模型G0.5在7大评测集刷新SOTA，具备零样本泛化能力，使机器人无需场景训练即可直接执行任务。硬件上，Kengo采用高标准化设计，仅两款核心模组覆盖全身关节，兼顾运动性能与成本控制。这标志着星海图从轮式机器人向双足形态的关键跨越，完善了“大脑×小脑×本体”全栈自研体系。\n\n### 影响分析\n1. 行业路径颠覆：传统双足机器人侧重运动控制，星海图反其道而行，以模型能力驱动硬件落地，可能重塑行业研发范式。零样本泛化能力直击“换场景变智障”痛点，加速机器人在商业、物流等场景的规模化部署。\n2. 商业潜力释放：高标准化模组设计降低制造成本与运维门槛，结合G0.5模型领先性能，星海图有望从开发者工具供应商升级为生产力平台，吸引汽车主机厂、物流运营商等B端客户。\n3. 竞争格局冲击：星海图在VLA模型、世界模型等前沿领域持续领跑，配合硬件矩阵扩展，或对波士顿动力等传统双足机器人厂商形成“模型降维打击”，推动行业从“炫技”转向“实用”竞争。",
    category: "robotics",
    source: "Exa 搜索",
  ...
  },
  {
    ...
    deepDive: "## AI 解读\n\n### 核心要点提炼\n1. 产品发布：NVIDIA推出Cosmos 3，基于混合Transformer架构，是全球首个完全开放的全模态物理AI基础模型，支持文本、图像、视频、环境音和动作的原生理解与生成。\n2. 生态联盟：成立NVIDIA Cosmos Coalition，联合Agile Robots、Runway等多家企业，推动开放世界模型开发，共享技术和基础设施。\n3. 应用价值：将物理AI训练周期从数月缩短至数天，适用于机器人、智能汽车和视觉AI的感知、推理、规划与行动，提供Super、Nano和Edge三种版本以满足不同场景需求。\n\n### 影响分析\nCosmos 3的发布标志着物理AI进入标准化与开放化新阶段。其全模态能力和混合架构显著降低了开发门槛，加速了机器人及自动驾驶等领域的模型迭代，有望推动行业从碎片化走向协同。同时，Cosmos Coalition的成立强化了NVIDIA在AI生态中的领导地位，通过开放合作吸引更多企业加入，形成技术飞轮效应。短期来看，这将提升相关领域合成数据生成和仿真效率；长期则可能重塑物理AI的竞争格局，使开放模型成为主流，并对封闭式平台构成挑战。",
    category: "robotics",
    source: "Exa 搜索",
  ...
  },
  {
    ...
    deepDive: "## AI 解读\n\n### 深度分析：英伟达人形机器人参考设计\n\n核心要点提炼：  \n英伟达于6月1日发布基于宇树H2 Plus的NVIDIA Isaac GR00T人形机器人参考设计，具备75个自由度，集成Jetson Thor计算平台、触觉五指手及多传感系统，AI性能达2070 FP4 teraflops，目标2026年底由宇树量产。此举标志着英伟达从芯片供应商向机器人全栈平台商转型，统一开发流程以加速行业落地。\n\n影响分析：  \n1. 行业生态重构：英伟达以开放参考设计降低人形机器人开发门槛，可能催生类似智能手机安卓的标准化平台，吸引初创企业及科研机构快速原型验证，推动产业链分工细化。  \n2. 竞争格局加剧：宇树借力英伟达生态提升技术溢价，特斯拉Optimus面临更激烈的开源生态挑战；同时，高自由度与触觉灵巧手设计强化了在精密操作场景（如制造、医疗）的竞争力。  \n3. 技术瓶颈突破：Jetson Thor的实时AI推理能力（2070 FP4 TFLOPS）与75自由度构型，为具身智能的“感知-规划-控制”闭环提供算力底座，但3小时续航与量产时间（2026年）表明能源与成本仍是关键制约。  \n\n结论：英伟达正以“算力+软件参考设计”双轮驱动，定义人形机器人技术栈标准，短期利好生态参与者，长期或重塑机器人产业价值分配。",
    category: "robotics",
    source: "Exa 搜索",
  ...
  },
  {
    ...
    deepDive: "## AI 解读\n\n### 深度分析：银河通用LDA——具身智能的“GPT-2时刻”\n\n1. 核心要点提炼\n\n银河通用发布的LDA模型，核心突破并非单一算法提升，而是首次在数据层面统一了异构数据（虚实、人机、有无动作标签），并构建了“世界-动作模型”（WAM）的范式。这标志着具身智能从依赖少量高质量数据的“稀缺驱动”，转向了以全量数据为燃料的“规模驱动”。其关键验证在于：模型性能随数据量（包括低质量、无标签数据）提升而持续增长，打破了传统BC方法的瓶颈。\n\n2. 影响分析\n\n   对行业： 具身智能的Scaling Law路径被正式确立。此前，机器人数据的高昂成本是行业痛点。LDA证明“数据多即是好”，极大降低了数据获取门槛。这将加速行业从“手工作坊”式的精细调教，迈向“大炼数据”的工业化阶段，具备数据基础设施能力的公司将占据先机。\n   对技术路线： 统一“世界模型”（预测）与“动作模型”（执行）的WAM范式，或将取代当前主流的VLA（视觉-语言-动作）模型，成为更底层的通用架构。这要求后续研究必须重新思考模型如何理解并作用于物理世界。\n   对商业化： 解决了数据瓶颈，机器人泛化能力的提升将加速。未来，机器人不再需要为每个任务、每个本体单独采集数据，通用基础模型的出现将大幅降低部署成本，推动人形机器人等具身智能产品从实验室走向规模化应用。",
    category: "robotics",
    source: "Exa 搜索",
