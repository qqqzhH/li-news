...
export default function HomePage() {
  ...
  return (
    <div className="snap-container space-y-0">
      ...
      {/* ===== Screen 2: 今日精选 ===== */}
      <section data-section="recommended" className="snap-start min-h-screen flex flex-col justify-start px-6 md:px-16 max-w-5xl mx-auto w-full" ref={section2Ref}>
        <div className="mt-[75vh] w-full">
          {/* Section header */}
